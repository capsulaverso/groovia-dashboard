-- Script SQL para criar tabelas do sistema Groovia (Versão Corrigida)
...
-- Tabela de Usuários (depende de clients)
...
-- Tabela de Agentes (depende de clients)
...
-- Tabela de Documentos (user_id sem constraint primeiro, adicionar depois)
...
-- Adicionar constraint depois que users existir
DO $$
BEGIN
  IF NOT EXISTS (
