...
/***/ "./node_modules/@plasmicapp/loader-gatsby/dist/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/@plasmicapp/loader-gatsby/dist/index.js ***!
  \**************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
__export(src_exports, {
  ...
  usePlasmicCanvasComponentInfo: () => import_loader_react4.usePlasmicCanvasComponentInfo,
...
var import_loader_react4 = __webpack_require__(/*! @plasmicapp/loader-react */ "./node_modules/@plasmicapp/loader-react/dist/index.js");

// src/gatsby-node.ts
var import_loader_react = __webpack_require__(/*! @plasmicapp/loader-react */ "./node_modules/@plasmicapp/loader-react/dist/index.js");
...
var allPaths = [];
var sourceNodes = (_0, _1) => __async(void 0, [_0, _1], function* ({
  actions,
  createContentDigest,
  reporter
}, opts) {
...
var createResolvers = ({
  createResolvers: createResolvers2
}, opts) => {
  createResolvers2({
    Query: {
      plasmicComponents: {
        ...
        resolve(_source, args, context, _info) {
          return __async(this, null, function* () {
            ...
            const components = yield getAllNodes(context.nodeModel, PLASMIC_NODE_NAME);
            const bundles = [];
            const compMetas = [];
            for (const component of components) {
              if (componentNames.includes(component.name) || componentNames.includes(component.displayName) || !!(component.path && componentNames.some(lookup => (0, import_loader_react.matchesPagePath)(component.path, lookup)))) {
            ...
            const renderData = (0, import_loader_react.convertBundlesToComponentRenderData)(bundles, compMetas);
            renderData == null ? void 0 : renderData.entryCompMetas.sort((meta1, meta2) =>
...
var createPages = (_0, _1) => __async(void 0, [_0, _1], function* ({
  graphql,
  actions,
  reporter,
  store
...
// src/gatsby-ssr.ts
var import_loader_react2 = __webpack_require__(/*! @plasmicapp/loader-react */ "./node_modules/@plasmicapp/loader-react/dist/index.js");
...
function fetchServerFiles(opts) {
  return __async(this, null, function* () {
    if ((opts == null ? void 0 : opts.projects) && Array.isArray(opts.projects) && opts.projects.every(p => !!p.token && !!p.id)) {
      const projectKeys = opts.projects.map(project => `${project.id}@${project.version}:${project.token}`);
...
var replaceRenderer = (_0, _1) => __async(void 0, [_0, _1], function* ({
  bodyComponent,
...
// src/loader.ts
var import_loader_react3 = __webpack_require__(/*! @plasmicapp/loader-react */ "./node_modules/@plasmicapp/loader-react/dist/index.js");
var Gatsby = __toESM(__webpack_require__(/*! gatsby */ "./.cache/gatsby-browser-entry.js"));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _plasmicapp_loader_gatsby__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @plasmicapp/loader-gatsby */ "./node_modules/@plasmicapp/loader-gatsby/dist/index.js");
/* harmony import */ var _plasmicapp_loader_gatsby__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_plasmicapp_loader_gatsby__WEBPACK_IMPORTED_MODULE_1__);


const PLASMIC = (0,_plasmicapp_loader_gatsby__WEBPACK_IMPORTED_MODULE_1__.initPlasmicLoader)({
  projects: [{
    id: "2tNCoxxWeRHCVGVD54hNmb",
    token: "1QCcLxjEOjtqvIOnPeQV3miA3LbDcBeIbI3xmNgn5VNytRkfxMhaWRHcrxr4Cm70JwfB62lEfDE0z7SVaag"
  }],
  preview: true
});
function Home() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_plasmicapp_loader_gatsby__WEBPACK_IMPORTED_MODULE_1__.PlasmicRootProvider, {
    loader: PLASMIC
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_plasmicapp_loader_gatsby__WEBPACK_IMPORTED_MODULE_1__.PlasmicComponent, {
    component: "Groovia"
  }));
}
